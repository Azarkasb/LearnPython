...
# Data
lifeExpectancy = {'JPN': {'Female': 87.5, 'Male': 81.1},
                 'ISR': {'Female': 84.4, 'Male': 81.1}, 'EU': {'Female': 83.8, 'Male': 78.6},
                 'USA': {'Female': 81.4, 'Male': 76.3}, 'IRN': {'Female': 77.7, 'Male': 75.4},
                 'RUS': {'Female': 77.6, 'Male': 66.9}, 'CAR': {'Female': 55.0, 'Male': 55.6}}
